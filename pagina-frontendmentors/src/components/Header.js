  ...
  return (
    <header>
      <div className={headerStyles.number_suggestions_and_sort}>
        ...
        <h3 className={headerStyles.number_suggestions}>
          {suggestions.length} Suggestions
        </h3>
        <div className={headerStyles.options}>
          <label htmlFor="sort" className={headerStyles.sort_label}>
            Sort by:
          </label>
          <select
            id="sort"
            ...
            className={headerStyles.sort_select}
          >
      ...
      <Link className='btn add_feedback' to='/add'>
        + Add feedback
      </Link>
    </header>
  );
